<template>
  <div class="asset-picker" role="dialog" aria-modal="true" aria-labelledby="asset-picker-title" @keydown.esc="$emit('close')">
    ...
    <section class="asset-picker__drawer">
      ...
      <div v-else class="asset-picker__state">No cataloged Visual Assets are available.</div>
      <footer>
...
.asset-picker__state { align-self: center; color: var(--builder-muted); text-align: center; }
